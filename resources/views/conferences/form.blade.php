<x-panel size="xl">
    <x-input.text name="title" label="*Title" :value="$conference->title"></x-input.text>
    ...
    <x-input.text name="url" label="*URL" :value="$conference->url" class="mt-8"></x-input.text>
        ...
        <template #default="{ form }">
            <div>
                <div class="flex items-center justify-between">
                    ...
                    <x-input.toggle name="has_cfp" label="Has CFP" v-model="form.hasCfp"></x-input.toggle>
                </div>
